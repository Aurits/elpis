...
class ElpisWebsite {
  ...
  initModernGallery() {
    ...
    this.galleryImages = [
      'gallery/art-exhibition-team.jpeg',
      'gallery/image (2).jpg',
      'gallery/image (4).jpg',
      'gallery/image (7).jpg',
      'gallery/image (8).jpg',
      ...
      'gallery/image (46).jpeg',
      'gallery/image (50).jpeg',
      'gallery/image (51).jpeg',
      'gallery/image (52).jpeg',
      'gallery/image (53).jpeg',
      'gallery/image (54).jpeg',
      'gallery/image (55).jpeg',
      'gallery/image (56).jpeg',
      'gallery/image (57).jpeg',
      'gallery/image (58).jpeg',
      'gallery/image (59).jpeg',
      'gallery/image (60).jpeg',
      'gallery/image (61).jpeg',
      'gallery/image (62).jpeg',
      'gallery/image (63).jpeg',
      'gallery/image (67).jpeg',
      'gallery/image (69).jpeg',
      'gallery/image (70).jpeg',
      'gallery/image (72).jpeg',
      'gallery/image (73).jpeg',
      'gallery/image (74).jpeg',
      'gallery/image (75).jpeg'
      // All 42+ images from gallery folder - can easily scale to 100+ images
    ]
